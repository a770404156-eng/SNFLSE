/* ─────────────────────────────────────────────────────────
  ...
  /* ── Auth state ──────────────────────────────────────────
     Setting BOTH the `hidden` attribute and `style.display`
     directly, so nothing else on the page can accidentally
     override visibility with a stray CSS rule. Until Firebase
     confirms a signed-in user, the dashboard is force-hidden. */
  function showLogin() {
  ...
  // Force-hidden immediately, before Firebase even responds.
  showLogin();
